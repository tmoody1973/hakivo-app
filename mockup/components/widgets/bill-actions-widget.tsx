                ...
                <TableBody>
                  {latestActions.map((bill, index) => (
                    <TableRow key={index} className="cursor-pointer">
                      <TableCell className="font-mono text-xs">{bill.number}</TableCell>
                      ...
                      <TableCell className="text-sm text-muted-foreground">{bill.action}</TableCell>
                      <TableCell className="text-xs text-muted-foreground text-right">{bill.date}</TableCell>
                    </TableRow>
                  ))}
                </TableBody>
              </Table>
